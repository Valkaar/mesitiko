...
INSERT IGNORE INTO `area` (`area_id`, `area_label`, `area_latitude`, `area_longitude`, `area_zoom`, `area_radius`, `area_municipality_id`) VALUES
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `customer_address_no` int(11) DEFAULT '0',
...
INSERT IGNORE INTO `customer_status` (`customer_status_id`, `customer_status_label`) VALUES
	(-1, 'Διαγραμμένος'),
	(1, 'Ενεργός'),
...
INSERT IGNORE INTO `customer_type` (`customer_type_id`, `customer_type_label`) VALUES
...
INSERT IGNORE INTO `heating` (`heating_id`, `heating_label`) VALUES
	(1, 'Χωρίς θέρμανση'),
	(2, 'Κλιματισμός'),
	(3, 'Ηλεκτρικά σώματα'),
	(4, 'Φυσικό αέριο'),
...
INSERT IGNORE INTO `municipality` (`municipality_id`, `municipality_label`, `municipality_latitude`, `municipality_longitude`, `municipality_zoom`, `municipality_radius`, `municipality_prefecture_id`) VALUES
...
INSERT IGNORE INTO `prefecture` (`prefecture_id`, `prefecture_label`, `prefecture_latitude`, `prefecture_longitude`, `prefecture_zoom`, `prefecture_radius`) VALUES
...
INSERT IGNORE INTO `property_media_type` (`property_media_type_id`, `property_media_type_label`) VALUES
	(1, 'Φωτογραφία'),
	(2, 'Βίντεο'),
	(3, 'Άλλο');
...
INSERT IGNORE INTO `property_status` (`property_status_id`, `property_status_label`) VALUES
	(-1, 'Διαγραμμένο'),
	(1, 'Διαθέσιμο'),
	(2, 'Πωλήθηκε'),
	(3, 'Ενοικιάστηκε'),
...
INSERT IGNORE INTO `property_type` (`property_type_id`, `property_type_label`) VALUES
	(1, 'Βίλα'),
	(2, 'Μεζονέτα'),
	(3, 'Μονοκατοικία'),
	(4, 'Διαμέρισμα'),
...
INSERT IGNORE INTO `request_status` (`request_status_id`, `request_status_label`) VALUES
	(-1, 'Διαγραμμένη'),
	(1, 'Ενεργή'),
	(2, 'Ανενεργή');
...
INSERT IGNORE INTO `transaction_type` (`transaction_type_id`, `transaction_type_label`) VALUES
	(1, 'Πώληση'),
	(2, 'Ενοικίαση'),
	(3, 'Αντιπαροχή'),
	(4, 'Ανταλλαγή'),
...
INSERT IGNORE INTO `user_status` (`user_status_id`, `user_status_label`) VALUES
	(-1, 'Διαγραμμένος'),
	(1, 'Ενεργός'),
