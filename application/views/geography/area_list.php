...
<script>
    $(document).ready(function () {
        $('#area_list').DataTable({
            "processing": true,
            "ajax": "<?= base_url(); ?>geography/get_areas_list",
            "columns": [
                {"data": "area_checked"},
                {"data": "area_id"},
                {"data": "area_label"},
            ...
            "rowCallback": function(row, data, index) {
                var action_html = "<a class='btn btn-success edit-button' href='<?= base_url(); ?>geography/edit_area/" + data.area_id + "'><span class='glyphicon glyphicon-pencil' title='Επεξεργασία'></span></a>";
