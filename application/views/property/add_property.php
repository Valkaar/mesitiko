<form class="form-inline" id="add_property_form">    
    <div class="row margin-bottom-30">
        ...
        <div class="col-md-4">
            <select class="form-control selectpicker" id="property_type_id" title="Επιλέξτε τύπο ακινήτου..." required>
        ...
        <div class="col-md-4">
            <select class="form-control selectpicker" id="property_status_id" title="Επιλέξτε διαθεσιμότητα..." required>
    ...
    <div class="row margin-bottom-30">
        <div class="col-md-4">
            <select class="form-control selectpicker" id="prefecture_id" title="Επιλέξτε νομό..." required>
        ...
        <div class="col-md-4">
            <select class="form-control selectpicker" id="municipality_id" title="Επιλέξτε δήμο..." required> 
        ...
        <div class="col-md-4">
            <select class="form-control selectpicker" id="area_id" title="Επιλέξτε πόλη/χωριό..." required>
    ...
    <div class="row margin-bottom-30">
        <div class="col-md-4">
            <div class="input-group">
                <input type="text" class="form-control" id="address" placeholder="Διεύθυνση" required>
                <span class="input-group-addon"></span>
                <input type="text" class="form-control" id="address_no" placeholder="Αριθμός" required>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <select class="form-control selectpicker" id="property_heating_id" title="Επιλέξτε τύπο θέρμανσης..." required>
    ...
    <div class="row margin-bottom-30">
        <div class="col-md-6">
            <textarea class="form-control" style="width:100%;" rows="5" cols="184" id="property_description" placeholder="Περιγραφή Ακινήτου" required></textarea>
        </div>
        <div class="col-md-6">
            <textarea class="form-control" style="width:100%;" rows="5" cols="184" id="property_description_en" placeholder="Περιγραφή Ακινήτου (Αγγλικά)" required></textarea>
        </div>
    </div>
    <div class="row margin-bottom-30">
        <div class="col-md-4">
            <input type="text" class="form-control" id="property_price" placeholder="Τιμή" style="width: 100%;" required>
        </div>
        <div class="col-md-4">
    ...
    <div class="row margin-bottom-30">
        <div class="col-md-4">
            <input type="text" class="form-control" id="balcony_sqm" placeholder="Τετραγωνικά μέτρα μπαλκονιού" style="width: 100%;" required>
        </div>
        <div class="col-md-4">
            <input type="text" class="form-control" id="garden_sqm" placeholder="Τετραγωνικά μέτρα κήπου" style="width: 100%;" required>
        </div>
        <div class="col-md-4">
            <input type="text" class="form-control" id="property_label" placeholder="Ετικέτα ακινήτου" style="width: 100%;" required>
        </div>
    </div>
    <div class="row margin-bottom-30">
        <div class="col-md-4">
